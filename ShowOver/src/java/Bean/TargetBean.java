...
public class TargetBean implements Serializable
{
    ...
    public String AddTarget(int intUserIndex)
    {
        ...
        try{
            ...
            dao.callableAddTarget(strTargetToAdd,strReleaseToAdd,strGenreToAdd,strSettingToAdd,strURLToAdd,intUserIndex);
        }catch(Exception ex){
            result = "Index";
        }
    ...
    public String AddTargetSuggestion(int intUserIndex)
    {
        ...
        try{
            dao.callableAddTargetSuggestion(strTargetToSuggest,strReleaseToSuggest,strGenreToSuggest,strSettingToSuggest,strURLToSuggest,intUserIndex);
        }catch(Exception ex){
            result = "Index";
        }
