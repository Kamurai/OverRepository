...
public class TargetBean implements Serializable
{
    ...
    public ArrayList<ArrayList<String>> PullTargetPair(String strUserIndex)
    {
        ...
        if(pairList.size() > 0)
        {
            ...
            TargetRelease1 = pairList.get(0).get(2);
        }
        else
        {
        ...
        if(pairList.size() > 1)
        {
            ...
            TargetRelease2 = pairList.get(1).get(2);
        }
        else
        {
    ...
    public String AddTarget(int intUserIndex)
    {
        ...
        try{
            ...
            dao.callableAddTarget(strTargetToAdd,strReleaseToAdd,strValueToAdd,strURLToAdd,intUserIndex);
        }catch(Exception ex){
            result = "Index";
        }
    ...
    public String AddTargetSuggestion(int intUserIndex)
    {
        ...
        try{
            dao.callableAddTargetSuggestion(strTargetToSuggest,strReleaseToAdd,strValueToSuggest,strURLToSuggest,intUserIndex);
        }catch(Exception ex){
            result = "Index";
        }
