...
BEGIN
	...
	select * from Users JOIN PlayOverUsers ON MasterUserIndex = Users.UserIndex where Username = @strUserName COLLATE SQL_Latin1_General_CP1_CS_AS and Passcode = @strPasscode COLLATE SQL_Latin1_General_CP1_CS_AS;
END