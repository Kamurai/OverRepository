...
Update Boxes SET L.Rank = 0 WHERE BoxIndex = 0;
Update Boxes SET L.Rank = 0 WHERE BoxIndex = 28;
Update Boxes SET L.Rank = 1 WHERE BoxIndex = 30;
...
Update Targets SET L.Rank = 0 WHERE TargetIndex = 10035;
Update Targets SET L.Rank = 1 WHERE TargetIndex = 10036;
Update Targets SET L.Rank = 2 WHERE TargetIndex = 10037;
